...
/usr/bin/samtools faidx /ref/fasta/jbrowse/$1.fa
/usr/local/bin/jbrowse add-assembly /ref/fasta/jbrowse/$1.fa --displayName="$2" --load copy --type indexedFasta --out /data/jbrowse2/
